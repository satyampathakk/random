...
async def websocket_endpoint(websocket: WebSocket, nickname: str, mode: str):
    ...
    if mode == "video":
        ...
        print(f"[VIDEO VISITOR] New video chat visitor! Total: {stats.video_chat_visitors}")
    
    print(f"[STATS] Visitors: {stats.total_visitors}, Connections: {stats.total_connections}, Video: {stats.video_chat_visitors}")
